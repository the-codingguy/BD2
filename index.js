...
function sortHotelsAscendingByPricing(hotel1, hotel2) {
  return hotel1.price - hotel2.price;
}
function sortHotelsDescendingByPricing(hotel1, hotel2) {
...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  if (sortType === 'low-to-high') {
    hotelsCopy.sort(sortHotelsAscendingByPricing);
  } else if (sortType === 'high-to-low') {
    hotelsCopy.sort(sortHotelsDescendingByPricing);
  }

  res.json({ hotels: hotelsCopy });
});

function sortHotelsAscendingByRating(hotel1, hotel2) {
  return hotel1.rating - hotel2.rating;
}
function sortHotelsDescendingByRating(hotel1, hotel2) {
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  if (sortType === 'low-to-high') {
    hotelsCopy.sort(sortHotelsAscendingByRating);
  } else if (sortType === 'high-to-low') {
    hotelsCopy.sort(sortHotelsDescendingByRating);
  }
  res.json({ hotels: hotelsCopy });
});

function sortHotelsAscendingByReviews(hotel1, hotel2) {
  return hotel1.reviews - hotel2.reviews;
}
function sortHotelsDescendingByReviews(hotel1, hotel2) {
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  if (sortType === 'least-to-most') {
    hotelsCopy.sort(sortHotelsAscendingByReviews);
  } else if (sortType === 'most-to-least') {
    hotelsCopy.sort(sortHotelsDescendingByReviews);
  }
...
app.get('/hotels/filter/amenity', (req, res) => {
  ...
  let results = hotels.filter((hotel) => {
    return filterHotelsByAmenity(hotel, amenity);
  });
...
app.get('/hotels/filter/country', (req, res) => {
  ...
  let results = hotels.filter((hotel) => {
    return filterHotelsByCountry(hotel, country);
  });
  res.json({ hotels: results });
});
...
app.get('/hotels/filter/category', (req, res) => {
  ...
  let results = hotels.filter((hotel) => {
    return filterHotelsByCategory(hotel, category);
  });
  res.json({ hotels: results });
});
